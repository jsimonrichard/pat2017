...
<div class="container">
	<div class="row">
		<div class="col-md-6 card">
			<div class="card-body">
				<h2 class="card-title">Topics Chronologically Organized</h2>
				<p class="card-text">Here, topics are ordered by date of creation.</p>
				<a href="/topics" class="btn btn-primary">Go</a>
			</div>
		</div>
		<div class="col-md-6 card">
			<div class="card-body">
				<h2 class="card-title">Topics Organized by Category</h2>
				<p class="card-text">Here, topics are organized by category.</p>
				<a href="/category" class="btn btn-primary">Go</a>
			</div>
		</div>
	</div>
</div>
